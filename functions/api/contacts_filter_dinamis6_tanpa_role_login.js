...
const corsHeaders = {
  // Selalu izinkan origin penanya (termasuk localhost/null) agar koneksi terbuka
  'Access-Control-Allow-Origin': origin || '*', 
  'Access-Control-Allow-Methods': 'GET, POST, PUT, DELETE, OPTIONS',
  'Access-Control-Allow-Headers': 'Content-Type, X-Table-Name, X-Custom-Auth',
